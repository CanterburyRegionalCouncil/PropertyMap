    ...
    function (
        ...
        var Widget = declare([_WidgetBase, _TemplatedMixin, Evented], {
            ...
            options: {
                ...
                //twitterURL: "https://twitter.com/intent/tweet?url={url}&text={title}&hashtags={hashtags}&via=canterburymaps",
                twitterURL: "https://twitter.com/intent/tweet?url={url}&text={title}&hashtags={hashtags}&via=canterbury_maps",
            ...
            _updateUrl: function () {
                ...
                if (this.get("useExtent") && map) {
                    ...
                    // Check if map was in geographc coordinates - 
                    if (gExtent == null)
                    {
                        // Call the geomtry service project function to convert to a geographic coordinate system 
                        var outSR = new SpatialReference(4326);
                        esriConfig.defaults.geometryService.project([map.extent], outSR, lang.hitch(this, function (projectedExtents) {
                            var gExtent = projectedExtents[0];
                            this.setUrl(gExtent);
                        }));
                    }
                    else {
